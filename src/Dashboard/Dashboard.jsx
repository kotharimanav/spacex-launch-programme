...
const Dashboard = (props) => {
    ...
    return (
        <div className="App">
            <div className="row">
                {data && data.length > 0 ? data.map(item => <div className="card m-3 col-lg-3 col-md-6 col-sm-12">
                    <div className="pt-2">
                        <img style={{ height: '140px', width: '220px' }} src={item.links && item.links.flickr_images[0]} />
                    </div>
